...
void* ProcessMemory::AllocateProcessMemory(int32_t p_ProcessId, uint32_t p_Size, int32_t p_Protection)
{
...
// TODO: Validate this against the kernel implementation
void ProcessMemory::FreeProcessMemory(int32_t p_ProcessId, void* p_Pointer)
{
...
bool ProcessMemory::WriteProcessMemory(int32_t p_ProcessId, void* p_ProcessAddress, void* p_InputData, uint32_t p_Size)
{
...
bool ProcessMemory::ReadProcessMemory(int32_t p_ProcessId, void* p_ProcessAddress, void* p_OutputData, uint32_t p_Size)
{
