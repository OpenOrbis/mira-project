...
#define PS4GDB_kcopyin()  auto kcopyin = (int(*)(const void *src, void *dst, size_t len)) kdlsym(copyin);
...
#define PS4GDB_kvm_fault_disable_pagefaults() auto kvm_fault_disable_pagefaults = (int(*)()) kdlsym(vm_fault_disable_pagefaults);
#define PS4GDB_kvm_fault_enable_pagefaults() auto kvm_fault_enable_pagefaults = (void(*)(int save)) kdlsym(vm_fault_enable_pagefaults);
#define PS4GDB_kcritical_enter() auto kcritical_enter = (void(*)()) kdlsym(critical_enter);
#define PS4GDB_kcritical_exit() auto kcritical_exit = (void(*)()) kdlsym(critical_exit);
